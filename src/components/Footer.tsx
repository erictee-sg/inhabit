...
const Footer = ({
  ...
  return (
    <footer className="bg-brand-black text-white py-16 px-4 md:px-8 lg:px-12 w-full">
      <div className="max-w-7xl mx-auto flex flex-col space-y-12">
        {/* Contact Section - First Row */}
        <div className="w-full">
          <ContactSection email={email} formRecipient={formRecipient} />
        </div>

        {/* Social Links - Second Row */}
        <div className="w-full flex flex-col items-center">
          <div className="border-t border-slate-800 pt-8 flex flex-col items-center w-full">
